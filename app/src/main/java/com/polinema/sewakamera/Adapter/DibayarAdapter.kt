...
class DibayarAdapter (var ctx: Context, private val dibayarList: ArrayList<Dibayar>) :
    RecyclerView.Adapter<DibayarAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val item: Dibayar = dibayarList[position]
