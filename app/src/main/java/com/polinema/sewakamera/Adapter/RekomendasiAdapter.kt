...
class RekomendasiAdapter (private val rekomendasiList: ArrayList<Produk>, context: Context): RecyclerView.Adapter<RekomendasiAdapter.ViewHolder>()  {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val product: Produk = rekomendasiList[position]
