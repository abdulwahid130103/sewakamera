...
class LunasAdapter  (var ctx: Context, private val lunasList: ArrayList<Lunas>) :
    RecyclerView.Adapter<LunasAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val item: Lunas = lunasList[position]
