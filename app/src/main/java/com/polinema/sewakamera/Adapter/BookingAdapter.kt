...
class BookingAdapter (var ctx: Context, private val bookingList: ArrayList<Booking>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val item: Booking = bookingList[position]
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val tampilkanLebihBanyakBooking: TextView = itemView.findViewById(R.id.tampilkanLebihBanyakBooking)
        val jumlahSemuaProdukBooking: TextView = itemView.findViewById(R.id.jumlahSemuaProdukBooking)
