...
class TolakAdapter(var ctx: Context, private val tolakList: ArrayList<Tolak>) :
    RecyclerView.Adapter<TolakAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val item: Tolak = tolakList[position]
